...
//  we have: id, name, tag name, class name, link text, partial link text, xpath, css selector
    ...
    public void test1() {
        ...
        // how to verify if check is not clicked?
        Assert.assertFalse(checkbox1.isSelected()); //assert that checkbox is not selected
        //[index] - to specify index of the element, if there are multiple elements with this path
    ...
    public void test2(){
        ...
        WebElement bluButton = driver.findElement(By.xpath("//*[text()='Blue']/preceding-sibling::input"));
        Assert.assertTrue(bluButton.isSelected(), "Blue button is not selected");
    }
