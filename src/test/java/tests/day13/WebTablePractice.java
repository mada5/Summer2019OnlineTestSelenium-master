...
public class WebTablePractice {
    ...
    @Test(description = "Verify that number of colums in the first table is equals to 6")
    public void set2(){
    ...
    public void test5(){
        ...
        int index = 1;
        List<WebElement> rows = driver.findElements(By.xpath("//table[@id='table1']//tbody/tr[" + index +"]//td"));
        for (WebElement cell: rows ){
            System.out.println(cell.getText());
        }
    }
